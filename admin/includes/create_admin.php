<h2 style="background-color:#fff; text-align:left; color:#000000">New Administrator Registration</h2>
<hr />
...
<form id="edit-profile" class="form-horizontal" action="dash.php" method="post">	
	...
	<div class="form-actions">
		...
		<div class="span4">
			<button type="submit" class="button btn btn-primary btn-large" style="padding:10px; font-size:180%" name="register_admin">Register</button>
		</div>
	</div>                    
</form>
