<form id="edit-profile" class="form-horizontal" action="app.php" method="post">
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			$clinician=mysqli_query($bd, "SELECT * FROM clinician"); 
			while ($row_clinician=mysqli_fetch_array($clinician)){
				...
				echo '
				<tr>
					<td> <p style="text-align:center"><strong> 3rdLClin#0'.$id.'</strong></p> </td>
					<td> <p style="text-align:center"><strong>'.$clinician_name.'</strong></p> </td>
