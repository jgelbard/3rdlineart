    ...
    while ( $row_sample=mysql_fetch_array($sample)){
        ...
        echo '
                  ...
                  <tr>
                    ...
                    <td> <p style="text-align:center"><strong>Sample Id: '. $date_created.'</strong></p> </td>
                    <td> <p style="text-align:center"><strong>From Facility:  <u>'. $art_clinic .'</u></strong></p>  </td>
       ...
       if($status =='Received'){ 
        ...
        <td class="td-actions"><a href="pih_p1.php?formID='.$form_id.'&sample='.$sample_id .'" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"> Repeat Test </i></a></td>';   
        }
