     ...
     <tr>
                               <td>
                                  ...
                                  <td>
                                    ...
                                    <p>* VL repeated and if  "> 1000" the sample should be shipped to NHLS. </p>
                                    <p>* VL repeated and if  "< 1000" SEND message to 3rd line sectretary. </p>
         </td>   
                              </tr>
                                                                                                                                                   ...
                                                                                                                                                   <div class="span3">
               <button class="btn" style="padding:10px; font-size:180%"><a href="#">Print Form</a></button>                                                                                                                                    </div>
                                                                                                                                                   <div class="span3"><!--
