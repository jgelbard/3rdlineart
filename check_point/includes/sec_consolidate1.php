...
<form id="edit-profile" class="form-horizontal" action="cp_p1.php?rev" method="post" style="background-color:#ccc; padding:20px">
...
<p><?php echo $fullname; ?></p>  
 <p>3rd Line committee secretary</p>                                     
                                        ...
                                        <p> Sending to: <u><?php echo $clinician_name; ?> </u>     Clinician at: <u><?php echo $art_clinic; ?> </u></p>
                                                                                                                                                   ...
                                                                                                                                                   <div class="span3">
               <button class="btn" style="padding:10px; font-size:180%"><a href="cp_p1.php?rev">Cancel</a></button>                                                                                                                                    </div>
                                                                                                                                                   <div class="span3"><!--
