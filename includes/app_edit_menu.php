...
$if_exist_pediatric_section = mysqli_num_rows ($pediatric_section);
	if ($if_exist_pediatric_section !='0' && $age < 4 ){		
		echo ' <div style="width:90%; background-color:#f2f2f2; border-radius: 5px; padding:5px; text-align:center; margin:5px;" >
		<a href="app.php?back&back_3&pat_id='.$pat_id.'&g='.$gender.'&xx='.$age.'" class="btn btn-warning"  style="width:90%;" >Pediatric Section</a>
	</div>';	
}
...
if ($if_exist_tb_treat != '0') {
	echo ' <div style="width:90%; background-color:#f2f2f2; border-radius: 5px; padding:5px; text-align:center; margin:5px;" >
	<a href="app.php?back&back_treatment3&pat_id='.$pat_id.'" class="btn btn-warning"   style="width:90%;" >TB Treatment</a>
</div>';
}
...
if ($if_exist_adherence_lab != '0') {	
	echo ' <div style="width:90%; background-color:#f2f2f2; border-radius: 5px; padding:5px; text-align:center; margin:5px;" >
	<a href=" app.php?back_adherence&pat_id='.$pat_id.'&g='.$gender.'&xx='.$age.'" class="btn btn-warning"   style="width:90%;" >ART Adherence & Lab</a>
</div>';
}
