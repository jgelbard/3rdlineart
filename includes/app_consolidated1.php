    ...
    while ($row_form_creation=mysqli_fetch_array($form_creation)){
       ...
       <tr>
                    ...
                    <p style="text-align:center"><strong>'.$date_reviewed.'</strong></p>
                        ...
                        <td class="td-actions"><a href="app.php?view&formid='. $_3rdlineart_form_id.'" style="float:right" class="btn btn-large btn-invert"><i class="btn-icon-only icon-ok"> View Review </i></a></td>
                    </tr>
