      ...
      <div class="box">
                         <tr>
                            ...
                            <h4>ART Interruptions?</h4>
                                  <!-- <div class="controls" style="position:relative; top:-20px; left:100px;">
                                            <label class="radio inline">
                                              <input type="radio"  name="art_interrup" value="intr_Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="art_interrup" value="intr_No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	--> 
...
<table style="width:100%" border="0" cellspacing="10px">
                              ...
                              <tr>
                                  ...
                                  <td> 
                                   <label class="control-label">Peripheral Neuropathy</label>
                                      <div style="width:110px; float:left" class="radio_sty">
    <input type="radio" id="f-option"   name="PeripheralNeuropathy" value="Yes" required>
    ...
    <div class="check">
                                     ...
                                     <!-- <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="PeripheralNeuropathy" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="PeripheralNeuropathy" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
    ...
    <input type="radio" id="j-option" name="Jaundice" value="Yes" required>
    ...
    <div class="check">
                                      ...
                                      <!--<div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="Jaundice" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="Jaundice" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
    ...
    <input type="radio" id="Lipodystrophy-yes" name="Lipodystrophy" value="Yes" required >
    ...
    <div class="check">
                                 ...
                                 <!--  <label class="control-label">Lipodystrophy</label>
                                      <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="Lipodystrophy" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="Lipodystrophy" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
    ...
    <input type="radio" id="KidneyFailure-yes" name="KidneyFailure" value="Yes"  required>
    ...
    <div class="check">
                                     ...
                                     <!-- <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="KidneyFailure" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="KidneyFailure" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
    ...
    <input type="radio" id="Psychosis-yes" name="Psychosis" value="Yes" required>
    ...
    <div class="check">
                                      ...
                                      <!--<div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="Psychosis" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="Psychosis" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
    ...
    <input type="radio" id="Gynecomastia-yes" name="Gynecomastia" value="Yes" required>
    ...
    <div style="width:100px; float:left" class="radio_sty">
    <input type="radio" id="Gynecomastia-no" name="Gynecomastia" value="No"  >
    ...
    <div class="check">
                                     ...
                                     <!-- <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="Gynecomastia" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="Gynecomastia" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                                  </tr>
...
<fieldset>
   <table style="width:100%" border="0">
    ...
    <div class="check">
                             ...
                             <!--<div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="ol_6months" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="ol_6months" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
</td>    
                                      <td>
    ...
    <div class="check">
                                     ...
                                     <!-- <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="sig_diarrhea_vom" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="sig_diarrhea_vom" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                           <td>
    ...
    <div class="check">
                              ...
                              <!--<div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="alco_drug_consump" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="alco_drug_consump" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                            <td>
    ...
    <div class="check">
                                      ...
                                      <!--<div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="trad_med" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="trad_med" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                          <td>
    ...
    <div class="check">
                                     ...
                                     <!-- <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="co_medi" value="Yes" id="app_radio"> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="co_medi" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                           <td>
    ...
    <div class="check">
                                    ...
                                    <!--  <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio"  name="other_curr_problem" value="Yes" id="app_radio" required> Yes
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="other_curr_problem" value="No" id="app_radio"> No
                                            </label>
                                          </div>	 /controls 	-->
                                  </td>
                           <td>
...
>>>>>>> bc4fb4e46591fc981ed16b8847acdd8d56add1b3
