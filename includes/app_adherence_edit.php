    ...
    <table style="width:100%" border="0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <input type="text" name="scheduled_visit_date1" id="datepickersVis_Date1" required value="<?php 
...
if (!empty ( $actual_visit_date1)) { echo  $actual_visit_date1; } ?> " required /> </td>
                    ...
                    <td> <input type="number" name="pill_count1" id="pill_count1" style="width:80px; height:50px;"  value="<?php 

if (!empty ( $pill_count1)) { echo  $pill_count1; } ?>" required /> </td>
                  
                  </tr> 
                     <tr>
                         <td><h4> Schedule visit date:</h4><label><i>(dd/mm/yyyy)</i> </td>
                    <td> <input type="text" name="scheduled_visit_date2" id="datepickersVis_Date2" required value="<?php 
...
if (!empty ( $actual_visit_date2)) { echo  $actual_visit_date2; } ?> " required/> </td>
                         <td><h4> Pill Count (%) </h4></td>
                    <td> <input type="number" name="pill_count2" id="pill_count2" style="width:80px; height:50px;" value="<?php 

if (!empty ( $pill_count2)) { echo  $pill_count2; } ?>" required/> </td>
                  
                  </tr> 
                    <tr>
                        <td> <h4>Schedule visit date: </h4><label><i>(dd/mm/yyyy)</i></td>
                    <td> <input type="text" name="scheduled_visit_date3" id="datepickersVis_Date3" required value="<?php 
...
if (!empty ( $actual_visit_date3)) { echo  $actual_visit_date3; } ?> "  required/> </td>
                        <td> <h4>Pill Count (%)</h4> </td>
                    <td> <input type="number" name="pill_count3" id="pill_count3" size="3" style="width:80px; height:50px;" value="<?php 

if (!empty ( $pill_count3)) { echo  $pill_count3; } ?>" required /> </td>
