...
$num_forms = mysqli_num_rows ($form_creation);
    ...
    while ($row_form_creation=mysqli_fetch_array($form_creation)){
        ...
        echo '
         <tr style="width:80%; background-color:#eff80a">
                    ...
                    <th class="td-actions" style="text-align:center"><p><strong>'.$gender.'</strong></p> </th>
                    <th class="td-actions" style="text-align:center"><p style="text-align:left"><strong>DOB: '. $dob.'</strong></p>  </th>
 ...
 <div class="form-actions">
                     ...
                     <h4><u>Download Attachemnts</u></h4>
