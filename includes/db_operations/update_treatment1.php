...
<div class="alert alert-success">
   ...
   ';
    ...
    $art_drug6= mysqli_real_escape_string($bd, htmlspecialchars($_POST['art_drug6']));
 	$start_date6= mysqli_real_escape_string($bd, htmlspecialchars($_POST['start_date6']));
	$stop_date6=mysqli_real_escape_string($bd, htmlspecialchars($_POST['stop_date6']));
	$reason_for_change6=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_for_change6']));
    
    $art_drug7= mysqli_real_escape_string($bd, htmlspecialchars($_POST['art_drug7']));
 	$start_date7= mysqli_real_escape_string($bd, htmlspecialchars($_POST['start_date7']));
	$stop_date7=mysqli_real_escape_string($bd, htmlspecialchars($_POST['stop_date7']));
	$reason_for_change7=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_for_change7']));
    
    $art_drug8= mysqli_real_escape_string($bd, htmlspecialchars($_POST['art_drug8']));
 	$start_date8= mysqli_real_escape_string($bd, htmlspecialchars($_POST['start_date8']));
	$stop_date8=mysqli_real_escape_string($bd, htmlspecialchars($_POST['stop_date8']));
	$reason_for_change8=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_for_change8']));
    
    $art_drug9= mysqli_real_escape_string($bd, htmlspecialchars($_POST['art_drug9']));
 	$start_date9= mysqli_real_escape_string($bd, htmlspecialchars($_POST['start_date9']));
	$stop_date9=mysqli_real_escape_string($bd, htmlspecialchars($_POST['stop_date9']));
	$reason_for_change9=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_for_change9']));
    
     $art_drug10= mysqli_real_escape_string($bd, htmlspecialchars($_POST['art_drug10']));
 	$start_date10= mysqli_real_escape_string($bd, htmlspecialchars($_POST['start_date10']));
	$stop_date10=mysqli_real_escape_string($bd, htmlspecialchars($_POST['stop_date10']));
	$reason_for_change10=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_for_change10']));
