...
if(isset($_POST['submit_treatment3'])){ 
    ...
    if ($tb_treat=='Yes'){
        ...
        if(isset($_POST['regimen1_checked'])){ 
                ...
                $reg_name12= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg12']));
                $tbstart_date12=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date12'])); 
                $tbstop_date12=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date12'])); 
                $reason_o_changes12=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes12'])); 
              
                $reg_name13= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg13']));
                $tbstart_date13=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date13'])); 
                $tbstop_date13=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date13'])); 
                $reason_o_changes13=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes13'])); 
              
                $reg_name14= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg14']));
                $tbstart_date14=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date14'])); 
                $tbstop_date14=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date14'])); 
                $reason_o_changes14=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes14'])); 
              
                $reg_name15= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg15']));
                $tbstart_date15=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date15'])); 
                $tbstop_date15=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date15'])); 
                $reason_o_changes15=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes15'])); 
        ...
        if(isset($_POST['regimen2_checked'])){ 
                ...
                $reg_name22= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg22']));
                $tbstart_date22=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date22'])); 
                $tbstop_date22=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date22'])); 
                $reason_o_changes22=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes22']));
            
                $reg_name23= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg23']));
                $tbstart_date23=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date23'])); 
                $tbstop_date23=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date23'])); 
                $reason_o_changes23=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes23']));
            
                $reg_name24= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg24']));
                $tbstart_date24=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date24'])); 
                $tbstop_date24=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date24'])); 
                $reason_o_changes24=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes24']));
            
                $reg_name25= mysqli_real_escape_string($bd, htmlspecialchars($_POST['reg25']));
                $tbstart_date25=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date25'])); 
                $tbstop_date25=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date25'])); 
                $reason_o_changes25=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes25']));
        ...
        if(isset($_POST['mdr_checked'])){ 
                ...
                $mdr2= mysqli_real_escape_string($bd, htmlspecialchars($_POST['mdr2']));
                $tbstart_date_mdr2=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date_mdr2'])); 
                $tbstop_date_mdr2=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date_mdr2'])); 
                $reason_o_changes_mdr2=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes_mdr2']));
            
                $mdr3= mysqli_real_escape_string($bd, htmlspecialchars($_POST['mdr3']));
                $tbstart_date_mdr3=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date_mdr3'])); 
                $tbstop_date_mdr3=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date_mdr3'])); 
                $reason_o_changes_mdr3=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes_mdr3']));
            
                $mdr4= mysqli_real_escape_string($bd, htmlspecialchars($_POST['mdr4']));
                $tbstart_date_mdr4=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date_mdr4'])); 
                $tbstop_date_mdr4=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date_mdr4'])); 
                $reason_o_changes_mdr4=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes_mdr4']));
            
                $mdr5= mysqli_real_escape_string($bd, htmlspecialchars($_POST['mdr5']));
                $tbstart_date_mdr5=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstart_date_mdr5'])); 
                $tbstop_date_mdr5=mysqli_real_escape_string($bd, htmlspecialchars($_POST['tbstop_date_mdr5'])); 
                $reason_o_changes_mdr5=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_o_changes_mdr5']));
