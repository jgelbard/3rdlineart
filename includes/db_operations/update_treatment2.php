...
<div class="alert alert-success">
   ...
   ';
    ...
    $monito_date6= mysqli_real_escape_string($bd, htmlspecialchars($_POST['monito_date6']));
 	$cd46= mysqli_real_escape_string($bd, htmlspecialchars($_POST['cd46']));
	$vl6=mysqli_real_escape_string($bd, htmlspecialchars($_POST['vl6']));
	$reason_4_detectable_vl6=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_4_detectable_vl6'])); 
	$weight6=mysqli_real_escape_string($bd, htmlspecialchars($_POST['weight6'])); 
    
    $monito_date7= mysqli_real_escape_string($bd, htmlspecialchars($_POST['monito_date7']));
 	$cd47= mysqli_real_escape_string($bd, htmlspecialchars($_POST['cd47']));
	$vl7=mysqli_real_escape_string($bd, htmlspecialchars($_POST['vl7']));
	$reason_4_detectable_vl7=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_4_detectable_vl7'])); 
	$weight7=mysqli_real_escape_string($bd, htmlspecialchars($_POST['weight7'])); 
    
    $monito_date8= mysqli_real_escape_string($bd, htmlspecialchars($_POST['monito_date8']));
 	$cd48= mysqli_real_escape_string($bd, htmlspecialchars($_POST['cd48']));
	$vl8=mysqli_real_escape_string($bd, htmlspecialchars($_POST['vl8']));
	$reason_4_detectable_vl8=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_4_detectable_vl8'])); 
	$weight8=mysqli_real_escape_string($bd, htmlspecialchars($_POST['weight8'])); 
    
   $monito_date9= mysqli_real_escape_string($bd, htmlspecialchars($_POST['monito_date9']));
 	$cd49= mysqli_real_escape_string($bd, htmlspecialchars($_POST['cd49']));
	$vl9=mysqli_real_escape_string($bd, htmlspecialchars($_POST['vl9']));
	$reason_4_detectable_vl9=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_4_detectable_vl9'])); 
	$weight9=mysqli_real_escape_string($bd, htmlspecialchars($_POST['weight9']));
    
    $monito_date10= mysqli_real_escape_string($bd, htmlspecialchars($_POST['monito_date10']));
 	$cd410= mysqli_real_escape_string($bd, htmlspecialchars($_POST['cd410']));
	$vl10=mysqli_real_escape_string($bd, htmlspecialchars($_POST['vl10']));
	$reason_4_detectable_vl10=mysqli_real_escape_string($bd, htmlspecialchars($_POST['reason_4_detectable_vl10'])); 
	$weight10=mysqli_real_escape_string($bd, htmlspecialchars($_POST['weight10'])); 
